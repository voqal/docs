...
The [Voqal Code Prompt](/prompting/library/code) is used for real-time oral and written natural language programming.
...
The [Voqal Command Prompt](/prompting/library/command) is used for a broad range of tasks, from writing entire functions,
...
The [Voqal Dictate Prompt](/prompting/library/dictate) is used for writing long-form text, such as documentation.
...
The [Voqal Edit Prompt](/prompting/library/edit) is used for editing code, text, and other content.
This prompt is designed for precision editing by first requiring the text which may be modified to first be focused on.

### Focus Mode

The [Voqal Focus Prompt](/prompting/library/focus) is used for focusing on specific parts of code, text, and other content.
This prompt is used as a precursor to the [Edit Prompt](/prompting/library/edit) and other prompts which require a specific focus.
