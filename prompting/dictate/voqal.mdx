...
The Voqal Dictate Prompt is used to convert spoken words into clean, punctuated, spelled, and grammatically correct text.
...
<Info>Prompt Name: Voqal Dictate Prompt<br/>Prompt Version: 1.0.0</Info>
...
{{ developer.partial_transcription }}
