...
Voqal flowing is the process of chaining and executing [Voqal Tools](/tools) via natural spoken language. There are
no specific keywords or syntax you need to remember to get flowing, but it does help to know the names and capabilities
of the tools your Voqal Assistant has access to. The better you understand the tools at your disposal,
the easier it will be to flow like a pro.

## Flowing Basics

The basic idea behind Voqal flowing is to chain together tools to create a flow that accomplishes a specific task. Each
tool has a specific purpose and can be used in a variety of ways. When you chain tools together, you are creating a
