...
The basic idea behind Voqal flowing is to quickly and efficiently execute some complex operation by delegating the actual work to your Voqal Assistant.
