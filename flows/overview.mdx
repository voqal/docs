...
The basic idea behind Voqal flowing is quickly and efficiently execute some complex operation by delegating the the actual work to your Voqal Assistant.
