...
description: "Give Voqal the ability to tell you the time."
icon: clock
---
...
a great example to show how easy it is to customize Voqal for dynamic and private data.
    ...
    embeddedServer(Netty, port = 8080) {
        routing {
            get("/time-aware-voqal") {
                ...
                val idleModeText = URL("https://voqal.dev/library/embedded/voqal-idle-mode.md").readText()
