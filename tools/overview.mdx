---
title: "Overview"
description: "Teach your Voqal Assistant a wide range of tasks to perform autonomously"
icon: sitemap
---
...
Voqal Tools provide the functionality offered via the [Voqal Idle Mode](/modes/embedded/idle). Voqal Tools are a set of
...
These tools are used to redirect a transcription to a different mode than the current. This allows you to quickly
switch between modes without having to manually telling your Voqal Assistant to switch modes.
