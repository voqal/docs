...
is useful when working with large text or source code files, allowing you to edit smaller sections of the file
at a time. This function will attempt to chunk code via natural breaks (e.g., functions, code blocks, etc) for
