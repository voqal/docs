...
[Pebble Templates](https://pebbletemplates.io/) are used to render the full context for given a given request.
For example, the following snippet shows how [Voqal Tools](/tools/overview) are added to the [Voqal Idle Mode](/modes/embedded/idle) context.
